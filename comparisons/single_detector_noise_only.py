...
# output the data
hetfile = os.path.join(outdir, 'data.txt')
...
result = bilby.run_sampler(
    ...
    sample='unif', outdir=outdir, label=label)

# compare evidences
print('Evidence (lalapps_pulsar_parameter_estimation): {}'.format(evsig))
print('Evidence (cwinpy): {}'.format(result.log_evidence))
print('Noise evidence (lalapps_pulsar_parameter_estimation): {}'.format(evnoise))
print('Noise evidence (cwinpy): {}'.format(result.log_noise_evidence))
