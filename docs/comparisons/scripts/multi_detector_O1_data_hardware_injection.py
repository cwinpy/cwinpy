...
from two detectors (H1 and L1). This uses a short chunk of data for the
hardware injection PULSAR8.
"""
...
# set the data files
hetfiles = [os.path.join("data", "fine-H1-PULSAR08.txt.gz"),
            os.path.join("data", "fine-L1-PULSAR08.txt.gz")]
